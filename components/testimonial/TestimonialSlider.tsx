  ...
  return (
    <div className="relative w-full">
      ...
      <button
        ...
        onClick={prevSlide}
        className="absolute left-1 md:left-0 top-1/2 -translate-y-1/2 z-20 flex h-11 w-11 items-center justify-center rounded-full bg-white shadow-lg hover:bg-gray-100 transition"
      >
        <ChevronLeft size={20} />
      </button>
      ...
      <button
        ...
        onClick={nextSlide}
        className="absolute right-1 md:right-0 top-1/2 -translate-y-1/2 z-20 flex h-11 w-11 items-center justify-center rounded-full bg-white shadow-lg hover:bg-gray-100 transition"
      >
